...
bool gB_BhopHitPerfV2[MAXPLAYERS + 1][AC_MAX_BHOP_SAMPLES_V2];
int gI_BhopPreJumpInputsV2[MAXPLAYERS + 1][AC_MAX_BHOP_SAMPLES_V2];
int gI_BhopPostJumpInputsV2[MAXPLAYERS + 1][AC_MAX_BHOP_SAMPLES_V2];
